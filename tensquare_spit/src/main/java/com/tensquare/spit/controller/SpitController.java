...
=======
    ...
    @GetMapping("children/{spitId}")
    public List<SpitPojo> findParentAndChildren( @PathVariable String spitId){
        List<SpitPojo> list = new ArrayList<>();
        return spitService.findChildren(spitId,list);
    }
>>>>>>> ed90e21... v1.0.0
}
